    ...
    def compress(self, input_file_path, output_file_path=None, verbose=False):
        ...
        try:
            with open(input_file_path, 'rb') as input_file:
                ...
                print('The size of input:', len(data))
        except IOError:
        ...
        if output_file_path:
            try:
                ...
                with open(output_file_path, 'wb') as output_file:
                    ...
                    print('The size of output', len(output_buffer.tobytes()))
...
if __name__ == '__main__':
    # LZ77 Compression
    LZ77_compressor = LZ77Compressor(window_size=500)  # window_size is optional
    input_file_path = 'Introduction to Data Compression.txt'
    output_file_path = 'test_LZ77.txt'

    # compress the input file and write it as binary into the output file
    LZ77_compressor.compress(input_file_path, output_file_path)